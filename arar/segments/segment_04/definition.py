...
from arar.materials.timespans.segment_04.convert_timespans import (  # handler_commands,
    rhythm_commands,
)
...
maker = evans.SegmentMaker(
    ...
    commands=[
        ...
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(5)),
        evans.attach("Voice 2", abjad.Articulation("accent"), baca.leaf(6)),
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(7)),
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(8)),
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(9)),
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(10)),
        evans.attach("Voice 2", abjad.Articulation("accent"), baca.leaf(11)),
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(12)),
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(13)),
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(14)),
        evans.attach("Voice 2", abjad.Articulation("accent"), baca.leaf(15)),
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(16)),
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(17)),
        evans.attach("Voice 2", abjad.Articulation("accent"), baca.leaf(18)),
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(19)),
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(20)),
        evans.attach("Voice 2", abjad.Articulation("accent"), baca.leaf(21)),
        evans.attach("Voice 2", abjad.Articulation("staccato"), baca.leaf(22)),
        evans.attach(
            "Voice 2",
            abjad.Markup(
